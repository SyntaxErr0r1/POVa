...
train_images = os.path.join(root_dir,"datasets/Merged_newest/train/images")
train_masks = os.path.join(root_dir,"datasets/Merged_newest/train/labels")
val_images = os.path.join(root_dir,"datasets/Merged_newest/val/images")
val_masks = os.path.join(root_dir,"datasets/Merged_newest/val/labels")
